...
def send_email(_sender_email, _receiver_email, _text):
    port = 465  # For SSL
    password = '2U!3tyJ#VSeyYwwR'  # input("Type your password and press enter: ")
    _result = False
...
def main():
    sender_email = "Waterdata Load <pps.smtp@gmail.com>"  # "Your name <Your email>"
    receiver_email = "wplaird@bigpond.com"
    
    subject = 'Errors found in '
    body = 'Log file attached '
    filename = 'data/downloads/logs/20210901123523.log'
    #message = 'Subject: {}\n\n{}'.format(subject, text)
