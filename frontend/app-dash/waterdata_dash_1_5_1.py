...
card_map = dbc.Card(
    ...
    ], style={'width': '100%', 'height': '50vh', 'margin': "auto", }, id="map"), #"display": "block"
...
#container_heatmap = dbc.Container(
#    [
#        dbc.Col(card_heatmap, 
#
#        ),
#    ]
#)
...
#                        dbc.Container(container_heatmap),
...
# subplots https://plotly.com/python/subplots/
    ...
    fig.update_layout(height=800,width=900,title_text="Groundwater, Surfacewater Comparison") #height=850, width=900, textfont_color=

    
    fig1 = px.scatter(dff, x='level_x', y='level_y')
    fig1.update_layout(hovermode='closest',xaxis_title='m1',yaxis_title='m2',title='Scatter',height=400, width=400) #height=250, width=250 400
...
#
#    fig4 = px.density_mapbox(dff, lat='LATITUDE', lon='LONGITUDE', z='APP_SQ_FT', radius=13, zoom=10, height=650,
#                            center=dict(lat=-30, lon=150), mapbox_style="carto-positron",
