...
dfe = df[(df['meter_no'] == 'CF419051')]

# Kaputar Rainfall Data
dfk = df[(df['meter_no'] == '54151')]
...
card_graph = dbc.Card(
        dcc.Graph(id='gw-graph', figure={}), body=True, color="secondary",
...
card_map = dbc.Card(
    ...
    ], style={'width': '100%', 'height': '40vh', 'margin': "auto", "display": "block"}, id="map"),
)
...
def update_graph(meter_no1, meter_no2, start_date, end_date): 
    ...
    fig.update_layout(hovermode='closest',xaxis_title='Time',yaxis_title='AHD',title='Comparison') #margin={'l': 40, 'b': 40, 't': 10, 'r': 0},
    
    # fig1 = px.line(dfe1, x='read_date', y='level')
    # fig1.update_layout(hovermode='closest',xaxis_title='Time',yaxis_title='AHD',title='Elfin Surfacewater')
    # fig2 = px.line(dfk1, x='read_date', y='level')
    # fig2.update_layout(hovermode='closest',xaxis_title='Time',yaxis_title='AHD',title='Kaputar Rainfall')
