...
def make_surfacewater_graph(data):
    ...
    fig = px.line(dfe, x='read_date', y='level')
    fig.update_layout(hovermode='closest',xaxis_title='41905',yaxis_title='Date',title='Elfin Crossing Line Plot',title_font_size=30) # ,height=400, width=465 / height=250, width=250 400
...
#
    ...
    #
    #fig.update_layout(title_text="Groundwater, Surfacewater Comparison",title_font_size=30,height=875,width=930)
